    ...
    <footer className="site-footer v6-footer">
      <div className="site-footer__columns v6-footer__grid">
        ...
        <FooterColumn title="Help + privacy">
          ...
          <a className="v6-footer-link" href="https://form.typeform.com/to/Jt7rx3BS?typeform-source=aynahealth.substack.com" target="_blank" rel="noreferrer">Give Us Feedback</a>
