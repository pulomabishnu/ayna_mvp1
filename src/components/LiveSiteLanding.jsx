      ...
      <section className="ayna-landing-band">
        <div className="mockup-page ayna-landing-band__inner">
          <div className="ayna-landing-band__copy">
            Log in to see your saved products and ecosystem.
            <span>Your picks, health profile, and personalized matches — all in one place.</span>
          </div>
...
export default function LiveSiteLanding({
  onLogIn,
  onStartQuiz,
  onViewDiscovery,
  onOpenProduct,
