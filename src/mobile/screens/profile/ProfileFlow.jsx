        ...
        {loadState === 'ready' && prefs && (
          <>
            <div style={{ background: 'var(--ayna-surface)', border: '1px solid var(--ayna-border)', borderRadius: 22, padding: '4px 18px' }}>
              ...
              <ToggleRow title="Join newsletter" sub="The Mirror — one letter a month, no products pushed." on={prefs.newsletterEnabled} onClick={() => patchField('newsletter_enabled', !prefs.newsletterEnabled, 'newsletterEnabled')} />
            </div>
